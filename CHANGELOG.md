...
* **029:** AI status clarity and download progress feedback ([83cf3f0](https://github.com/timdixon82/SWOT-Builder/commit/83cf3f0017519d2707f6edbafae0ceef3a8caa63))
* AI status clarity and download progress feedback ([045bbe7](https://github.com/timdixon82/SWOT-Builder/commit/045bbe778bfd1d0b0a7c3715287c8f1316d28186))
* AI status clarity and download progress feedback ([#18](https://github.com/timdixon82/SWOT-Builder/issues/18)) ([045bbe7](https://github.com/timdixon82/SWOT-Builder/commit/045bbe778bfd1d0b0a7c3715287c8f1316d28186))
* **scripts:** add next-q.sh for session Q-number display ([7c33fb6](https://github.com/timdixon82/SWOT-Builder/commit/7c33fb667536a775fa1431bb9953c1f35a7f7db7))
* **scripts:** add next-q.sh so session-start displays the next Q-number ([83d5d64](https://github.com/timdixon82/SWOT-Builder/commit/83d5d647cea1cd6f683fda292f549e72500a411c))
...
* AIBadge em dash and clear progressText on ready ([b606ff8](https://github.com/timdixon82/SWOT-Builder/commit/b606ff898e411db53e27361edbbfb62e59e9561c))
* AIBadge em dash and clear progressText on ready ([31ed84c](https://github.com/timdixon82/SWOT-Builder/commit/31ed84c594d99fc13d6cb23565ed0b8caf61b37f))
* AIBadge em dash and clear progressText on ready ([#19](https://github.com/timdixon82/SWOT-Builder/issues/19)) ([b606ff8](https://github.com/timdixon82/SWOT-Builder/commit/b606ff898e411db53e27361edbbfb62e59e9561c))
* always require download consent (Q27B) and wire coach-tone into AI (Q30A) ([ef01f51](https://github.com/timdixon82/SWOT-Builder/commit/ef01f51209e9c3b4b496d652df7ec321d8dc6a2c))
* always require download consent (Q27B) and wire coach-tone into AI (Q30A) ([410658a](https://github.com/timdixon82/SWOT-Builder/commit/410658ade660187c8a392558a7b83bf5cf471c92))
* always require download consent (Q27B) and wire coach-tone into AI (Q30A) ([#20](https://github.com/timdixon82/SWOT-Builder/issues/20)) ([ef01f51](https://github.com/timdixon82/SWOT-Builder/commit/ef01f51209e9c3b4b496d652df7ec321d8dc6a2c))
...
* **security:** correct nosemgrep rule IDs in tweaks-panel.jsx ([c492935](https://github.com/timdixon82/SWOT-Builder/commit/c49293593bfb08b61d55504a9d7799247fa9c3a5))
* **security:** patch pre-tool-use.sh — six safety-hook vulnerabilities ([eb0be06](https://github.com/timdixon82/SWOT-Builder/commit/eb0be06b3c39e6a995c3316c53dc2c7bab266962))
* **security:** patch pre-tool-use.sh — six safety-hook vulnerabilities ([bd50599](https://github.com/timdixon82/SWOT-Builder/commit/bd50599cca1505becef5469ad73111da709bc4b3))
...
* **security:** suppress pre-existing semgrep findings with rationale ([f357ddc](https://github.com/timdixon82/SWOT-Builder/commit/f357ddc7b3291ecc9b50c709fca1ba2e66217a05))
